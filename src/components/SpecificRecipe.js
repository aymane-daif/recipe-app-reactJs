                ...
                <div className="columns">
                  <div className="column">
                    <div className="recipe-detail">     
                      <p><strong>Cuisine: </strong>{specificRecipe.cuisineType.join(" ")}</p> 
                    </div>
                    <div className="recipe-detail">    
                      <p><strong>Calories: </strong> {specificRecipe.calories.toFixed(2)}</p>
                    </div>
                    <div className="recipe-detail">    
                      <p><strong>Diet: </strong> {specificRecipe.dietLabels.join(" ")}</p>
                    </div>
                    <div className="recipe-detail">
                      <p><strong>Meal Type: </strong> {specificRecipe.mealType.join(" ")}</p>
                    </div>
                  </div>
                  <div className="column">
                    <div className="recipe-ingredients">
                      ...
                      <ul>
                        {specificRecipe.ingredients.map((ingredient,idx) => {
                          return <li key={idx}><FaSitemap /> {ingredient.text}, (Category) {ingredient.foodCategory}</li>
                        })}
                      </ul>
                    </div>
                  </div>
